    ...
    <section className="relative py-24 bg-gradient-to-b from-green-50 via-white to-green-50 overflow-hidden">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0" style={{
          backgroundImage: 'url(https://images.pexels.com/photos/164537/pexels-photo-164537.jpeg?auto=compress&cs=tinysrgb&w=1920)',
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-bold text-gray-800 mb-6 italic"
          >
          ...
          >
            <span className="font-semibold">Indowud nfc is a sustainable eco-friendly panel product for all exterior & interior furnishing and joinery applications.</span> It is a zero-wood product, a superior alternative to tropical wood and wood-based panels like plywood, MDF/HDF in many ways.
          </motion.p>
        </motion.div>
          ...
          {features.slice(0, 5).map((feature, index) => (
            ...
            >
              <motion.div
                ...
                className="w-20 h-20 mb-4 bg-white rounded-full flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-shadow"
              >
