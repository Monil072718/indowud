    ...
    <footer className="relative bg-gradient-to-b from-gray-100 to-gray-200 pt-20 pb-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {footerLinks.map((link, index) => (
                ...
                >
                  <motion.div
                    ...
                    className="w-1.5 h-1.5 bg-rose-500 rounded-full group-hover:bg-teal-500 transition-colors"
                  />
                  {link.title}
                </motion.a>
              ))}
        ...
        <motion.div
          ...
          className="h-px bg-gradient-to-r from-transparent via-gray-400 to-transparent mb-8"
        />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          >
            © 2023 INDOWUD. All Rights Reserved.
          </motion.p>
        </div>
      </div>
      ...
      <motion.div
        ...
        className="absolute top-20 right-0 w-64 h-64 bg-teal-300 rounded-full blur-3xl opacity-20"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-20 left-0 w-64 h-64 bg-rose-300 rounded-full blur-3xl opacity-20"
      />
    </footer>
  );
}
