import { BlogCardPost } from "@/components/sections/blog/BlogCard";

export interface BlogPost extends BlogCardPost {
  author: {
    name: string;
    avatar?: string;
  };
...
export const blogPosts: BlogPost[] = [
  ...
  {
    id: "2",
    slug: "wpc-ply-board-compared-to-plywood",
    ...
    author: { name: "Indowud Team" },
    html: `
        <p>Picking the wrong board can bring dampness, termites, and huge repair bills later. That's why knowing the difference between WPC ply board and plywood matters. Let's break down how they compare so you can choose the right one.</p>

        <br/>
        <strong>When You Pick Materials, Safety, Use, and Cost Change a Lot.</strong>
        <br/>
        <p>Picking the wrong board can bring dampness, termites, and huge repair bills later. That's why knowing the difference between WPC ply board and plywood matters. Let's break down how they compare so you can choose the right one.</p>

        <br/>
        <strong>How They Perform Where You Live: Water, Heat, and More</strong>
        <br/>

        <br/>
        <strong>Is It Water Resistant?</strong>
        <br/>
        <p>WPC ply board wins here. It is 100% waterproof. You can soak it in water for days, and it won't swell or rot. That makes it perfect for kitchens, bathrooms, and basements. Plywood absorbs water. Even the water-resistant kind eventually swells and peels if it stays wet. Using it in damp areas is risky.</p>

        <br/>
        <strong>Fire, Termites, and Bugs</strong>
        <br/>
        <p>WPC defends itself well. It doesn't attract termites because it contains plastic. Termites eat wood, so they love plywood. Unless you treat plywood with strong chemicals, termites will destroy it. WPC is also fire-retardant. It doesn't catch fire easily, which adds safety to your home. Plywood burns fast, spreading fire quickly.</p>

        <br/>
        <strong>Strength and Structure</strong>
        <br/>
        <p>Plywood relies on layers of wood glued together. If the glue fails, the layers peel apart. This happens often in cheap plywood. WPC boards are solid. They don't have layers. This makes them strong and uniform. You can cut them anywhere, and the edge stays smooth. They hold screws tight and don't crack easily.</p>

        <br/>
        <strong>How Long They Last and Hold Up</strong>
        <br/>
        <p>WPC ply board is built to last. It doesn't rot, warp, or fade easily. You can expect it to look good for decades. Plywood has a shorter life. It can warp if the weather changes often. It needs paint or varnish to stay protected. Without that, it starts looking old and worn out in a few years.</p>

        <br/>
        <strong>Looking at Cost: Upfront Spend Versus Total Savings</strong>
        <br/>
        <p>Plywood often costs less to buy at first. If you are on a tight budget, it looks like a good deal. WPC ply board costs more upfront. But think about the long run. You don't need to paint WPC. You don't need to replace it because of rot or termites. Over time, WPC saves you money.</p>

        <br/>
        <strong>Where Each Fits Best</strong>
        <br/>
        <p>Use WPC ply board for cabinets, shelves, wall panels, and furniture. It works great in kitchens and bathrooms. It is also good for outdoor furniture because weather doesn't hurt it. Use plywood for subfloors, roofing, and structural framing where it gets covered up. It is strong but needs protection.</p>

        <br/>
        <strong>Thinking About the Environment</strong>
        <br/>
        <p>WPC uses recycled plastic and wood waste. It saves trees. It is an eco-friendly choice. Plywood needs fresh timber. While trees grow back, cutting them down affects forests. WPC is a better choice if you care about the planet.</p>

        <br/>
        <strong>How to Look and Touch Them</strong>
        <br/>
        <p>Plywood looks like wood because it is wood. You can stain it to look beautiful. WPC can look like wood too. It comes in many colors and textures. You can get it in a plain color or a wood grain finish. It looks modern and clean.</p>

        <br/>
        <strong>Ease of Use and Workability</strong>
        <br/>
        <p>Plywood creates dust and splinters when you cut it. You need sharp tools. WPC cuts smoothly. It doesn't splinter. It is easier to work with. You can mold it into shapes too. This makes it great for creative designs.</p>
